...
public final class FragmentProgramBinding implements ViewBinding {
  ...
  private FragmentProgramBinding(@NonNull ConstraintLayout rootView, @NonNull ImageView imageView) {
  ...
  public static FragmentProgramBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentProgramBinding((ConstraintLayout) rootView, imageView);
    }
